...
public class AlbumTrackDao {
    ...
    public AlbumTrack getAlbumTrack(String asin, int trackNumber) {
        AlbumTrack albumTrackKey = new AlbumTrack();
        albumTrackKey.setAsin(asin);
        albumTrackKey.setTrackNumber(trackNumber);
        return dynamoDbMapper.load(AlbumTrack.class, albumTrackKey);
    }
}
